...
SELECT
    ...
    CONCAT('Uni v1 LP ', token_0_symbol, ' - ', 'ETH') AS label,
...
SELECT
    ...
    CONCAT('Uni v2 LP ', token_0_symbol, ' - ', token_1_symbol) AS label,
    'lp_pool_name' AS type,
    'masquot' AS author
...
SELECT
    f.pool_address AS address,
    CONCAT('Uni v3 LP ', token_0_symbol, ' - ', token_1_symbol) AS label,
    'lp_pool_name' AS type,
    'masquot' AS author
